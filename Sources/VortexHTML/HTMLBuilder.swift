...
extension HTMLBuilder {
    ...
    public static func buildOptional<Content: HTML>(_ component: Content?) -> Never {
      fatalError()
    }

    @available(*, unavailable)
    public static func buildEither<TrueContent: HTML, FalseContent: HTML>(first component: TrueContent) -> Never {
      fatalError()
    }

    @available(*, unavailable)
    public static func buildEither<TrueContent: HTML, FalseContent: HTML>(second component: FalseContent) -> Never {
      fatalError()
    }

    @available(*, unavailable)
    public static func buildArray<Element: HTML>(_ components: [Element]) -> Never {
      fatalError()
    }
}
#endif
